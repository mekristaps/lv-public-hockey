    ...
    useEffect(() => {
        ...
        if (formState?.success) {
            ...
            if (formState.generatedPin && formState?.type === 'register') {
                setNewPin(formState.generatedPin);
                setDialogOpen(true);
                setDialogTitle('Reģistrācija veiksmīga!');
                ...
                if (formState.phoneChanged) {
                    setNewPin(formState.updatedProfile.pin_code);
                    setDialogOpen(true);
                    setDialogTitle('Telefona numurs nomainīts!');
                }
